...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='coco/img')
    parser.add_argument('--source_xml_path', type=str, default='coco/xml')
    parser.add_argument('--save_img_path', type=str, default='coco/aug/a')
    parser.add_argument('--save_xml_path', type=str, default='coco/aug/b')
